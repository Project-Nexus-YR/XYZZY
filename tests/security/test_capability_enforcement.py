...
async def test_a_valid_owner_addressed_identity_still_cannot_write_for_a_viewer(
    ...
    with_identity = (
        await svc.agent_capability_terms(room_id, agent.agent_id, "viewer_member")
    ).lendable()
    ...
    revoked_terms = await svc.agent_capability_terms(room_id, agent.agent_id, "viewer_member")
