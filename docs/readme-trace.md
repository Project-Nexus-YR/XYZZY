...
| 56 commits since v0.4.0 (CHANGELOG Unreleased), re-measured 2026-09-05 | `git log v0.4.0..HEAD --oneline | wc -l` | `56` (measured as the commit that refreshed this row landed) |
